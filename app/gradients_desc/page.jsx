    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100 text-gray-800 flex">
        ...
        <div className="flex-grow p-6 ml-[400px]">
          ...
          <br />
          <p className="text-lg">
            This means: If you increase w₁ a little, the loss increases a lot. If you increase w₂ a little, the loss also
            increases, but slightly less. So, to minimize the loss, you want to go in the <b>opposite direction of the
            gradient.</b>
          </p>
          <br />
          <br />
          ...
          <br />
          <div className="flex justify-center">
            <Image src={img3} width={600} height={600} alt="slope" />
          </div>
          <br />
          <br />
